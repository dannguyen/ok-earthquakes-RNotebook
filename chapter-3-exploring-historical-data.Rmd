...
ggplot(data = filter(top_quakes, year >= 2010), aes(x1)) +
  ...
  geom_histogram(data=filter(top_quakes, STUSPS == "OK", year >= 2010), binwidth = 1, fill="orange") +
...
ggplot(data = ok_quakes, aes(year)) +
  ...
  geom_histogram(data = filter(ok_quakes, year == 2015), binwidth = 1, fill="#990000", color = "#FFFFFF", linetype = 'dashed', size = 1.0) +
...
ggplot(data = ok_quakes, aes(year_month)) +
  ...
  scale_x_discrete(breaks=c("2008-01", "2012-01", "2014-01")) +
